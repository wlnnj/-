        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, authStore.login(username.value, password.value)];
                case 2:
                    _c.sent();
                ...
                case 3:
                    err_1 = _c.sent();
                    error.value = ((_b = (_a = err_1.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || '登录失败，请检查用户名和密码';
                    return [3 /*break*/, 5];
                case 4:
                    loading.value = false;
                    return [7 /*endfinally*/];
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "login-card glass-card" }, { ref: "formRef" }));
/** @type {__VLS_StyleScopedClasses['login-card']} */ ;
/** @type {__VLS_StyleScopedClasses['glass-card']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.h2, __VLS_intrinsics.h2)(__assign({ class: "login-title" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.form, __VLS_intrinsics.form)(__assign({ onSubmit: (__VLS_ctx.handleLogin) }, { class: "login-form" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "register-link" }));
/** @type {__VLS_StyleScopedClasses['register-link']} */ ;
var __VLS_0;
...
// @ts-ignore
[handleLogin, username, password, error, error, loading, loading,];
var __VLS_3;
// @ts-ignore
[];
